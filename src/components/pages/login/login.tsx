...
import { AUTH_LOGIN } from "../../../redux/auth/actions";
      ...
      <div className="flex items-center justify-center min-h-screen gradient-bg bg-gray-900">
        <div className="w-full max-w-md p-8 bg-white rounded-lg shadow-md border border-gray-600">
          ...
          <form className="flex flex-col gap-3" onSubmit={handleSubmit}>
            ...
            <button className="  px-4 py-2 rounded cursor-pointer font-semibold hover:bg-gray-600 transition duration-300 ease-in-out">
              Нет аккаунта?
            </button>
          </form>
        </div>
