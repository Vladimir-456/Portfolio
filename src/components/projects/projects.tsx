 ...
 useEffect(() => {
  ...
  return (
    <section id="projects" className="container mx-auto px-4 py-6">
      <h2 className="text-2xl font-bold mb-6 bg-gradient-to-r from-indigo-600 via-pink-500 to-yellow-400  bg-clip-text text-transparent">Мои проекты</h2>
      <input 
      type="text"
      className="mb-4 mt-3 w-1/2 p-2 border text-white bg-gray-900 border-gray-300 rounded-md focus:outline-none focus:border-indigo-500" 
